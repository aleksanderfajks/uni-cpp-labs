...
int main() {
    ...
    std::cout << "Bubble Sort: " << std::chrono::duration_cast<std::chrono::nanoseconds>(end1 - start1).count() << " ns\n";
    std::cout << "Quick Sort: " << std::chrono::duration_cast<std::chrono::nanoseconds>(end2 - start2).count() << " ns\n";
    std::cout << "Merge Sort: " << std::chrono::duration_cast<std::chrono::nanoseconds>(end3 - start3).count() << " ns\n";
